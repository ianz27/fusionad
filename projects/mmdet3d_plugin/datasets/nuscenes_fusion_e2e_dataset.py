...
class NuScenesFusionE2EDataset(NuScenesDataset):
    r"""NuScenes Fusion E2E Dataset.
    ...
    def union2one(self, queue):
        ...
        for i, each in enumerate(queue):
            points_list.append(each['points'].data)  # use list of list of torch tensor
