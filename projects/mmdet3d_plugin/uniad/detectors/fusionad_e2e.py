...
class FusionAD(FusionADTrack):
    ...
    def forward_train(self,
        ...
        # # debug
        # print('img: ', img.shape)  # [bs, frame, cam, c, h, w]
        # print('points: ', len(points))  # num of batch size
        # print('points[0]: ', len(points[0]))  # num of frame size
    ...
    def forward_test(self,
        ...
        # TODO: MUST do this, otherwise out of memory, why foward_train OK ?
        pop_track_list = ['prev_bev', 'bev_pos', 'bev_embed', 'track_query_embeddings', 'sdc_embedding']
        # pop_track_list = ['prev_bev', 'bev_embed', 'track_query_embeddings', 'sdc_embedding']
